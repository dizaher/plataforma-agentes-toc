    ...
    <div class="row">
        <div class="carousel bg-transparent" id="carousel1">
          <div class="slide">
            ...
            <div class="span5">
              <img src="<?php echo base_url(); ?>img/Noticias/C_1.jpg" alt="" class="cover1" />
            </div>                                                                                         
          </div>
          <div class="slide">
            ...
            <div class="span5">
              <img src="<?php echo base_url(); ?>img/Noticias/E_2.jpg" alt="" class="cover1" />
            </div>
          </div>
          <div class="slide">
            ...
            <div class="span5">
              <img src="<?php echo base_url(); ?>img/Noticias/SAR_1.jpg" alt="" class="cover1" />
            </div>
          </div>
  ...
  <div class="row">      
    <div class="span4">                     
      <div class="panel no-border">
        <div class="panel-header fg-dark">Sistema de monitoreo de productos</div>
        <div class="panel-content fg-dark nlp nrp">                 
          La empresa TOC en colaboración con un alumno de maestría de ingeniería de software desarrollan un sistema de monitoreo de los valores sensados por los productos piloto. El monitoreo se basa en verificar el estado de los productos piloto que se tienen instalados en el hogar, con el fin de observar su funcionamiento, además se cuentan con técnicas de minería de datos para la recolección.
          <a class="button" href="#">Ver Nota &raquo;</a></p>
        </div>
      </div>
    </div>
    <div class="span4">
      <div class="panel no-border">
        <div class="panel-header fg-dark">Sistema acuaponico chinampero</div>
        <div class="panel-content fg-dark nlp nrp">          
          Descubre como la empresa TOC, TECHNOLOGY OUTSOURCING CENTER SA DE CV, ha desarrollado un sistema para dar una solución al tema de alimentos frescos y de calidad al alcance de uno, con un sistema que combina dos técnicas agropecuarias más la inclusión de un método ancestral de los Aztecas, para, la obtención de vegetales y peces, de la cosecha a tú mesa.
          <a class="button" href="#">Ver Nota &raquo;</a></p>
        </div>
      </div>
    </div>
    <div class="span4">
      <div class="panel no-border">
        <div class="panel-header fg-dark">Motor Stirling  versión 2.0</div>
        <div class="panel-content fg-dark nlp nrp">          
          La empresa TOC construye un motor para bombear y generar electricidad, es un motor Stirling tipo gamma o motor de combustión externa. Este motor genera un trabajo mecánico gracias a la variación de presión provocada por una diferencia de temperaturas. Los motores Stirling funcionan a volumen constante, el gas que se puede ocupar es helio, hidrogeno, nitrógeno, metano y aire, este último es el gas de trabajo que se ocupa en este motor prototipo. 
          <a class="button" href="#">Ver Nota &raquo;</a>
        </div>
      </div>
    </div>                             
  </div>
